...
class CIL_Architecture:
    ...
    def __init__(self, input_shape, configuration):
        ...
        weights = configuration["weights"] # Weights for L1 loss
        batch_size = configuration["batch_size"]
        
        # If specified, Adam optimizer is used.
    ...
    def __model_creation(self, version = 1):
        ...
        # straight_branch = Dense(3,name='straight_branch')(straight_branch) # If you want to use linear activation uncomment this line and commends the following ones.
        ...
        #left_branch = Dense(3,name='left_branch')(left_branch) # If you want to use linear activation uncomment this line and commends the following ones.
        ...
        #right_branch = Dense(3,name='right_branch')(right_branch) # If you want to use linear activation uncomment this line and commends the following ones.
        ...
        follow_branch = Dense(3,name='follow_branch')(follow_branch) # If you want to use linear activation uncomment this line and commends the following ones.
        ...
        #speed_branch = Dense(1,name='speed_branch')(speed_branch) # If you want to use linear activation uncomment this line and commends the following ones.
    ...
    def predict(self, X):
        """ Passing an input this function makes a prediction and returns the results."""
