...
- starts the training running main.py, passing the configuration file
...
2) Run the dataset.loader.py file. Example:
...
Also can find the application of the Tanh-PReLU configuration described in the thesis.
